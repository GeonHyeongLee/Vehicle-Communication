...
"ASW/autopark/autopark.src":"../ASW/autopark/autopark.c" "ASW/autopark/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/USER/AURIX-v1.10.16-workspace/Vehicle-Communication/projectWon-develop/src/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
...
clean-ASW-2f-autopark:
	-$(RM) ./ASW/autopark/autopark.d ./ASW/autopark/autopark.o ./ASW/autopark/autopark.src
